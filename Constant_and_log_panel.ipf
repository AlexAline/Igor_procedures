...
function init_Constant_and_log_panel()
	...
	constant_name[0] = "G0"
	constant_value[0] = 7.748091e-5/2
...
Window Constant_and_log_panel() : Panel
	...
	SetVariable number_of_constants,pos={8,12},size={160,14},proc=set_number_of_constants,title="Number of constants:"
	SetVariable number_of_constants,limits={0,max_number_of_constants,1},value= number_of_constants
	Button init_button, pos={190,12}, size={70,18}, proc=init_constants, title="Initialize"
