...
//	DACRange=10000
//	dacdivider=1						
//	DACLimit = 10000/DACDivider	
//	variable i=1//;string id="c",id2
//	do	
//		DACLabel[i]="Channel "+num2str(i)
//		//id2=id+num2str(i)
//		//setval(id2,0)
//		i+=1
//	while(i<NumChan)
//	DAC[0]=nan;DACOffset[0]=nan;DACRange[0]=nan;DACDivider[0]=nan;DACLimit[0]=nan;DACLabel[0]=""
//	
//	if(wintype("DACstatus")==0)
//		Edit/W=(498.75,38,762,200.75) DACLabel,DAC,DACDivider,DACLimit,DACOffset as "DACstatus"
...
function CalDAC(chan)
	...
	variable/g dmm2
	string readname="read_"+num2str(nextwave())
